...
var RegisterPort = /*#__PURE__*/function (_Component) {
  ...
  _createClass(RegisterPort, [{
        ...
        axios.post('api/port/register', {
          ...
          if (response.data.success) {
            ...
            var timer = setTimeout(function () {
              _this3.props.history.push('/login_port');
            }, 3000);
          } else {
    ...
    value: function render() {
      ...
      }, "Port")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["Card"], {
        className: "mx-4"
