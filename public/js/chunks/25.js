...
/***/ "./resources/coreui/src/views/Admin/BookAppointment/BookAppointment.js":
/*!*****************************************************************************!*\
  !*** ./resources/coreui/src/views/Admin/BookAppointment/BookAppointment.js ***!
  \*****************************************************************************/
...
var BookAppointment = /*#__PURE__*/function (_Component) {
  _inherits(BookAppointment, _Component);

  var _super = _createSuper(BookAppointment);
  ...
  function BookAppointment(props) {
    ...
    _this.state = (_this$state = {
      ...
      // //////////////////////////////////
      view: false
    }, _defineProperty(_this$state, "status", ""), _defineProperty(_this$state, "showDiv", "none"), _defineProperty(_this$state, "loading", false), _defineProperty(_this$state, "login_as", ""), _this$state);
  ...
  _createClass(BookAppointment, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.state.login_as != "admin_user") {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/admin/list_appointments?token=".concat(this.state.token)).then(function (response) {
    ...
    value: function handlePageChange(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/admin/list_appointments?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
          _this3.setState({
    ...
    value: function onSubmit(e) {
      ...
      if (this.state.reply_subject == "" || this.state.reply_message == "" || this.state.reply_subject == null || this.state.reply_message == null) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("/api/admin/reply/appointment_message/" + this.state.id + "?token=".concat(this.state.token), appointment_data).then(function (response) {
          return response;
        }).then(function (json) {
          // ////////// LOADER //////////////
          _this4.setState({
    ...
    value: function changeStatus(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/admin/general_appointments/change_status/" + id + "?token=".concat(this.state.token)).then(function (response) {
        console.log("ROI Cartoon");
        console.log(response);
        return response;
      }).then(function (json) {
    ...
    value: function render() {
      ...
      }), " List of General Appointments Requests"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Table"], {
        responsive: true,
        bordered: true
      ...
      this.state.list.map(function (appointment) {
        if (appointment.status == 1) {
          _this6.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Button"], {
            ...
            onClick: function onClick() {
              return _this6.changeStatus(appointment.id);
            },
            active: true,
            color: "danger",
            title: "Make as read",
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          size: "sm",
          onClick: function onClick() {
            return _this6.toggleReply(appointment.id, appointment.name, appointment.email, appointment.subject, appointment.message);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1",
          title: "Reply appintment message"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      ...
      }, "Reply Message"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ModalBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Card"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["CardHeader"], null, "Reply Appointment Message"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Col"], {
        xs: "12",
        sm: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Card"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Col"], {
        xs: "12",
