...
/***/ "./resources/coreui/src/views/AssociateLabsList/AssociateLabsList.js":
/*!***************************************************************************!*\
  !*** ./resources/coreui/src/views/AssociateLabsList/AssociateLabsList.js ***!
  \***************************************************************************/
...
var AssociateLabsList = /*#__PURE__*/function (_Component) {
  _inherits(AssociateLabsList, _Component);

  var _super = _createSuper(AssociateLabsList);

  function AssociateLabsList(props) {
    var _this$state;

    var _this;

    _classCallCheck(this, AssociateLabsList);

    _this = _super.call(this, props); // ////////////////MODAL    

    _this.toggleLaboratoryView = function (username, name, zip_code, telephone, email, country, district_province_state, address, logo) {
      _this.setState({
    ...
    _this.toggleLaboratoryView = _this.toggleLaboratoryView.bind(_assertThisInitialized(_this));
  ...
  _createClass(AssociateLabsList, [{
    ...
    value: function viewLabPatient(lab_id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/lab/patients_list/" + lab_id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this5.toggleViewLabPatient);
        } else {
          _this5.setState({}, _this5.toggleViewLabPatient);
        }
      })["catch"](function (error) {
        // redirect user to previous page if user does not have autorization to the page
        hashHistory.push('/premontessori');
    ...
    value: function handlePageChange(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/lab/patients_list/" + this.state.lab_id + "?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        ...
        if (json.data.success) {
          ...
          _this6.setState({}, _this6.toggleViewLabPatient);
        }
      });
    } // //////////////////////////////////////////////////////////////////////
      ...
      this.state.labs_list.map(function (lab) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this7.toggleLaboratoryView(lab.username, lab.name, lab.zip_code, lab.telephone, lab.email, lab.country, lab.district_province_state, lab.address, lab.logo);
          },
          ...
          size: "sm",
          onClick: function onClick() {
            return _this7.viewLabPatient(lab.id);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1",
        ...
        toggle: function toggle() {
          return _this7.toggleLaboratoryView("close", "close");
        }
        ...
        className: "fa fa-align-justify"
      }), this.state.name, " Laboratory's Data"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Col"], {
        xs: "12",
        sm: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Card"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Col"], {
        xs: "3",
        ...
        toggle: function toggle() {
          return _this7.toggleViewLabPatient("close", "close");
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        className: "fa fa-align-justify"
  ...
  return AssociateLabsList;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (AssociateLabsList);
