...
var HospitalListDoctors = /*#__PURE__*/function (_Component) {
  ...
  _createClass(HospitalListDoctors, [{
    ...
    value: function checkIfProfileCompleted() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/hospital/get/" + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
    ...
    value: function getPateintMedicalRec(patient_id, name) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/doc/patientMedRec/get/" + patient_id + '/' + this.state.doctor_id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this10.togglePatientRec(patient_id, name));
        } else {
          _this10.setState({
    ...
    value: function viewAppointment(patient_id, name) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/doc/appointment/get/" + patient_id + '/' + this.state.doctor_id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          if (_this11.state.appointment_status == 2) {
            _this11.setState({
          ...
          if (_this11.state.appointment_status == 3) {
            _this11.setState({
    ...
    value: function render() {
      var _this14 = this; // const { product_image} = this.state
      ...
      this.state.doctors_list.map(function (doctor) {
        if (doctor.status == 1) {
          _this14.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Badge"], {
            color: "success"
          }, "Consultation Open");
        } else {
          _this14.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_8__["Badge"], {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this14.viewDoctorPatient(doctor.id);
          },
        ...
        toggle: function toggle() {
          return _this14.toggleViewDoctorPatient("close", "close");
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        className: "fa fa-align-justify"
