...
/* harmony import */ var react_paypal_button_v2__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! react-paypal-button-v2 */ "./node_modules/react-paypal-button-v2/lib/index.js");
/* harmony import */ var react_paypal_button_v2__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(react_paypal_button_v2__WEBPACK_IMPORTED_MODULE_8__);
  ...
  _createClass(PatientListDoctors, [{
    ...
    value: function onSubmitBookAppointment2() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.post("/api/patient/book_doc_appointment_pay/" + this.state.doctor_id + '/' + this.state.id + "?token=".concat(this.state.token), appointment_data).then(function (response) {
        ...
        if (json.data.success) {// this.setState({ 
          //   successMessage: "Appointment booked successfully.",
          //   showSuccess: true
          // });
        } else {
    ...
    value: function handlePageChangeAppointments(pageNumber) {
      var _this16 = this; // console.log(`active page is ${pageNumber}`);
      // this.setState({activePage: pageNumber});
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        xs: "12",
        lg: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Card"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "Loading..."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["CardHeader"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      ...
      this.state.doctors_list.map(function (doctor) {
        if (doctor.status == 1) {
          _this17.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Badge"], {
            color: "success"
          }, "Completed");
        } else {
          _this17.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Badge"], {
        ...
        if (doctor.gender == "0") {
          _this17.state.gender = "Not specified";
        }

        if (doctor.gender == "1") {
          _this17.state.gender = "Male";
        }

        if (doctor.gender == "2") {
          _this17.state.gender = "Female";
        }

        if (doctor.gender == "3") {
          _this17.state.gender = "Prefer not to say";
        }

        if (doctor.gender == "4") {
          _this17.state.gender = doctor.gender_others;
        }
        ...
        toggle: function toggle() {
          return _this17.toggleViewDoctor("close", "close");
        }
      ...
      }, this.state.doctor_last_name))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Col"], {
        xs: "6"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["ListGroup"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["ListGroupItem"], {
        className: "justify-content-between"
        ...
        className: "justify-content-between"
      }, "Consultation Fee: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("strong", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        style: {
          textAlign: "right"
        }
      }, "$", this.state.doctor_consultation_fee)))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Row"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Col"], {
        xs: "12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["ListGroup"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["ListGroupItem"], {
        className: "justify-content-between"
      ...
      this.state.appointments_list.map(function (appointment) {
        ...
        if (appointment.status == 1) {
          ...
          _this17.state.chatBtn = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Button"], {
            size: "sm",
            onClick: function onClick() {
              return _this17.getDoctorFee(appointment.doc_id);
            },
            className: "btn-facebook btn-brand icon mr-1 mb-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        ...
        if (appointment.status == 2) {
          ...
          _this17.state.chatBtn = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Button"], {
            size: "sm",
            onClick: function onClick() {
              return _this17.togglePrimary(appointment.doc_id, name);
            },
            className: "btn-facebook btn-brand icon mr-1 mb-1"
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
      ...
      }, "You can pay with your paypal account or with your debit or credit card."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_paypal_button_v2__WEBPACK_IMPORTED_MODULE_8__["PayPalButton"], {
