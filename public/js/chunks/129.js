...
var PatientProfile = /*#__PURE__*/function (_Component) {
  ...
  function PatientProfile(props) {
    ...
    _this.state = (_this$state = {
      ...
      currentPage2: ''
    }, _defineProperty(_this$state, "status", '1'), _defineProperty(_this$state, "medical_share_port_list", []), _defineProperty(_this$state, "number_port", 1), _defineProperty(_this$state, "activePage_port", 1), _defineProperty(_this$state, "itemsCountPerPage_port", 1), _defineProperty(_this$state, "totalItemsCount_port", 1), _defineProperty(_this$state, "pageRangeDisplayed_port", 3), _defineProperty(_this$state, "currentPage2_port", ''), _defineProperty(_this$state, "status_port", '1'), _defineProperty(_this$state, "allow_patient_update_med", 'block'), _defineProperty(_this$state, "showSuccess", false), _defineProperty(_this$state, "showError", false), _defineProperty(_this$state, "successMessage", "Successful"), _defineProperty(_this$state, "errorMessage", "Failed"), _defineProperty(_this$state, "countries", []), _defineProperty(_this$state, "login_as", ""), _this$state);
    return _this;
  }
