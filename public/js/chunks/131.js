...
var PharmAccount = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PharmAccount, [{
    ...
    value: function checkIfProfileCompleted() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/pharm/get/" + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
    ...
    value: function render() {
      var _this5 = this; // const { product_image} = this.state
