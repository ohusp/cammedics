...
var FlutterWaveButton = function (_a) {
    ...
    return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", { disabled: disabled, className: className, onClick: function () { return handleFlutterwavePayment({ callback: callback, onClose: onClose }); } }, text || children));
};
