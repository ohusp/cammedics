...
/***/ "./resources/coreui/src/views/Pages/ResetPasswordAssociate/ResetPasswordAssociate.js":
/*!*******************************************************************************************!*\
  !*** ./resources/coreui/src/views/Pages/ResetPasswordAssociate/ResetPasswordAssociate.js ***!
  \*******************************************************************************************/
...
var ResetPasswordAssociate = /*#__PURE__*/function (_Component) {
  _inherits(ResetPasswordAssociate, _Component);

  var _super = _createSuper(ResetPasswordAssociate);

  function ResetPasswordAssociate(props) {
    var _this;

    _classCallCheck(this, ResetPasswordAssociate);
  ...
  _createClass(ResetPasswordAssociate, [{
    key: "onChangeState",
    ...
    value: function onSubmit(e) {
      ...
      if (this.state.password == "" || this.state.confirmPassword == "") {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('api/associate/resetPassword', {
          ...
          if (response.data.success) {
            ...
            var timer = setTimeout(function () {
              _this2.props.history.push('/login_associate');
            }, 3000);
            return function () {
    ...
    value: function componentDidMount() {
      ...
      try {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('api/associate/check', {
          ...
          if (json.data.success) {} else _this3.props.history.push("/login_associate");
        })["catch"](function (err) {
          // if theres error redirect to login page
          // console.log(err)
          _this3.props.history.push("/login_associate");
        });
      } catch (error) {
        // if theres error redirect to login page
        // console.log(error)
  ...
  return ResetPasswordAssociate;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (ResetPasswordAssociate);
