...
/***/ "./resources/coreui/src/views/AssociateLabAccount/AssociateLabAccount.js":
/*!*******************************************************************************!*\
  !*** ./resources/coreui/src/views/AssociateLabAccount/AssociateLabAccount.js ***!
  \*******************************************************************************/
...
var AssociateLabAccount = /*#__PURE__*/function (_Component) {
  _inherits(AssociateLabAccount, _Component);

  var _super = _createSuper(AssociateLabAccount);

  function AssociateLabAccount(props) {
    var _this$state;

    var _this;

    _classCallCheck(this, AssociateLabAccount);

    _this = _super.call(this, props); // ////////////////MODAL    

    _this.toggleViewLabAccount = function () {
      _this.setState({
        primaryLabAccount: !_this.state.primaryLabAccount
      });
    };

    _this.toggleViewLabAccount = _this.toggleViewLabAccount.bind(_assertThisInitialized(_this));
  ...
  _createClass(AssociateLabAccount, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.state.login_as != "associate") {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/associate/list_labs/" + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
    ...
    value: function handlePageChangeLabs(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/associate/list_labs/" + this.state.id + "?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
          _this3.setState({
    ...
    key: "getAccount",
    value: function getAccount(lab_id) {
      var _this5 = this;

      this.setState({
        lab_id: lab_id
      });
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/associate/lab/account/" + lab_id + "?token=".concat(this.state.token)).then(function (response) {
        // console.log("ROI Cartoon");
        // console.log(response);
        return response;
      }).then(function (json) {
    ...
    value: function handlePageChangeGetAccount(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/associate/lab/account/" + this.state.lab_id + "?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
          _this6.setState({
    ...
    value: function render() {
      ...
      }), " List of Laboratories"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_5__["CardBody"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_5__["Table"], {
        responsive: true,
        bordered: true
      ...
      this.state.labs_list.map(function (lab) {
        ...
        var patient_id = lab.patient_id;
        var name = lab.patient_first_name + " " + lab.patient_last_name + " " + lab.patient_middle_name;
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this7.getAccount(lab.id);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1",
          title: "View laboratory's patient"
        ...
        isOpen: this.state.primaryLabAccount,
        ...
        toggle: function toggle() {
          return _this7.toggleViewLabAccount("close", "close");
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        className: "fa fa-align-justify"
  ...
  return AssociateLabAccount;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (AssociateLabAccount);
