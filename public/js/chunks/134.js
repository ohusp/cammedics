...
var PharmProfile = /*#__PURE__*/function (_Component) {
  ...
  function PharmProfile(props) {
    ...
    _this.state = (_this$state = {
      ...
      currentPage2: ''
    }, _defineProperty(_this$state, "status", '1'), _defineProperty(_this$state, "successMessage", "Successful"), _defineProperty(_this$state, "errorMessage", "Failed"), _defineProperty(_this$state, "login_as", ""), _this$state);
    return _this;
  }
