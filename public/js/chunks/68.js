...
var ResetPasswordDoc = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ResetPasswordDoc, [{
    ...
    value: function componentDidMount() {
      ...
      try {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('api/doctor/check', {
          ...
          if (json.data.success) {} else _this3.props.history.push("/login_doctor");
        })["catch"](function (err) {
          // if theres error redirect to login page
          // console.log(err)
          _this3.props.history.push("/login_doctor");
        });
      } catch (error) {
        // if theres error redirect to login page
        // console.log(error)
    ...
    value: function render() {
      ...
      }, "Doctor")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["CardGroup"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_2__["Card"], {
        className: "p-4"
