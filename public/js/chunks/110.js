...
var DocProfile = /*#__PURE__*/function (_Component) {
  ...
  function DocProfile(props) {
    ...
    _this.state = (_this$state = {
      ...
      currentPage2: ''
    }, _defineProperty(_this$state, "status", '1'), _defineProperty(_this$state, "showSuccess", false), _defineProperty(_this$state, "showError", false), _defineProperty(_this$state, "successMessage", "Successful"), _defineProperty(_this$state, "errorMessage", "Failed"), _defineProperty(_this$state, "med_cert_uploaded", ""), _defineProperty(_this$state, "med_lic_uploaded", ""), _defineProperty(_this$state, "show", false), _defineProperty(_this$state, "countries", []), _defineProperty(_this$state, "login_as", ""), _this$state);
    return _this;
  }
