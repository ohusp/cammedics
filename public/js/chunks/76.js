  ...
  _createClass(PatientListPharms, [{
    ...
    value: function getMessages1(pharm_id) {
      ...
      this.interval = setInterval(function () {
        return _this10.getMessages2(pharm_id);
      }, 5000);
    } // get messages
    ...
    value: function getMessages2(pharm_id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/patient/pharm/chat/message/get/" + pharm_id + '/' + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this11.loadMessages(json.data.messages.message));
        } else {}
      })["catch"](function (error) {// redirect user to previous page if user does not have autorization to the page
        // hashHistory.push('/premontessori');
        // console.error(`An Error Occuredd! ${error}`);
    ...
    value: function submitSendFile(e) {
      var _this12 = this; // e.preventDefault() // Stop form submit
    ...
    value: function render() {
      ...
      this.state.pharms_list.map(function (pharm) {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this13.viewPharm(pharm_id, pharm_name);
          },
          ...
          size: "sm",
          onClick: function onClick() {
            return _this13.togglePrimary(pharm_id, pharm_name);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        ...
        toggle: function toggle() {
          return _this13.toggleViewPharm("close", "close");
        }
      ...
      this.state.product_list.map(function (product) {
        ...
        toggle: function toggle() {
          return _this13.toggleViewProduct("close", "close");
        }
        ...
        color: "primary",
        onClick: function onClick() {
          return _this13.addToCart(_this13.state.product_id);
        }
