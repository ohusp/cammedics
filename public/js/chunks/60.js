...
/***/ "./resources/coreui/src/views/Pages/RegisterAssociate/RegisterAssociate.js":
/*!*********************************************************************************!*\
  !*** ./resources/coreui/src/views/Pages/RegisterAssociate/RegisterAssociate.js ***!
  \*********************************************************************************/
...
var RegisterAssociate = /*#__PURE__*/function (_Component) {
  _inherits(RegisterAssociate, _Component);

  var _super = _createSuper(RegisterAssociate);

  function RegisterAssociate() {
    var _this;

    _classCallCheck(this, RegisterAssociate);
  ...
  _createClass(RegisterAssociate, [{
    key: "onChangeState",
    ...
    value: function onSubmit(e) {
      ...
      if (this.state.username == "" || this.state.name == "" || this.state.email == "" || this.state.password == "" || this.state.confirmPassword == "") {
        ...
        axios.post('api/associate/register', {
    ...
    value: function render() {
      ...
      }, "Associate")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_1__["Card"], {
        className: "mx-4"
...
/* harmony default export */ __webpack_exports__["default"] = (RegisterAssociate);
