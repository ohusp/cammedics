...
var HospitalAccount = /*#__PURE__*/function (_Component) {
  ...
  _createClass(HospitalAccount, [{
    ...
    value: function handlePageChangeGetAccount(pageNumber) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/api/hospital/account/" + this.state.id + "?token=".concat(this.state.token, "&page=") + pageNumber).then(function (response) {
        return response;
      }).then(function (json) {
        if (json.data.success) {
          _this6.setState({
