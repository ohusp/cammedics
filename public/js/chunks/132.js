  ...
  _createClass(PharmListOrders, [{
    ...
    value: function getMessages1(patient_id) {
      ...
      this.interval = setInterval(function () {
        return _this7.getMessages2(patient_id);
      }, 5000);
    } // get messages
    ...
    value: function render() {
      ...
      this.state.order_list.map(function (order) {
        if (order.status == 1) {
          _this10.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_12__["Badge"], {
            color: "danger"
          }, "Not Delivered");
        } else {
          _this10.state.status = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_12__["Badge"], {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this10.viewOrder(order_id, order.billing_cart_total);
          },
          ...
          size: "sm",
          onClick: function onClick() {
            return _this10.togglePrimary(patient_id, patient_username);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
          ...
          size: "sm",
          onClick: function onClick() {
            return _this10.delivered(order_id, order.patient_id);
          },
          className: "btn-facebook btn-brand icon mr-1 mb-1"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", {
        ...
        toggle: function toggle() {
          return _this10.toggleViewOrder("close", "close");
        }
      ...
      this.state.cart_list.map(function (item) {
        ...
        toggle: function toggle() {
          return _this10.togglePrimary("close", "close");
        }
