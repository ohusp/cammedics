...
var DocListPatients = /*#__PURE__*/function (_Component) {
  ...
  function DocListPatients(props) {
    ...
    }, _defineProperty(_this$state, "status", ""), _defineProperty(_this$state, "created_at", localStorage["appState"] ? JSON.parse(localStorage["appState"]).user.created_at : ""), _defineProperty(_this$state, "user_type", localStorage["appState"] ? JSON.parse(localStorage["appState"]).user.user_type : ""), _defineProperty(_this$state, "collapse", false), _defineProperty(_this$state, "collapse_identification", false), _defineProperty(_this$state, "collapse_app_instructions", false), _defineProperty(_this$state, "fadeIn", true), _defineProperty(_this$state, "timeout", 300), _defineProperty(_this$state, "patient_id", ""), _defineProperty(_this$state, "patient_name", ""), _defineProperty(_this$state, "startDate", new Date()), _defineProperty(_this$state, "primary", false), _defineProperty(_this$state, "primaryViewAppointment", false), _defineProperty(_this$state, "patientRec", false), _defineProperty(_this$state, "showSuccess", false), _defineProperty(_this$state, "showError", false), _defineProperty(_this$state, "successMessage", "Successful"), _defineProperty(_this$state, "errorMessage", "Failed"), _defineProperty(_this$state, "chat_btn_status", false), _defineProperty(_this$state, "login_as", ""), _this$state);
    ...
    value: function getPateintMedicalRec(patient_id, name) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/api/doc/patientMedRec/get/" + patient_id + '/' + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          }, _this8.togglePatientRec(patient_id, name));
        } else {
          _this8.setState({
    ...
    value: function viewAppointment(patient_id, name) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("/api/doc/appointment/get/" + patient_id + '/' + this.state.id + "?token=".concat(this.state.token)).then(function (response) {
        ...
        if (json.data.success) {
          ...
          if (_this9.state.appointment_status == 3) {
            _this9.setState({
      ...
      this.state.applications_list.map(function (application) {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          onClick: function onClick() {
            return _this12.getPateintMedicalRec(patient_id, name);
          },
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "mcu");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "mcu",
          style: {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "all");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "all",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "blo");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "blo",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "fmh");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "fmh",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "hyp");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "hyp",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "dia");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "dia",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "und");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "und",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "pre");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "pre",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_10__["ListGroupItem"], {
          key: meds.id,
          onClick: function onClick() {
            return _this12.toggleMedRecTab(meds.id + "not");
          },
          action: true,
          active: _this12.state.activeTab === meds.id + "not",
          style: {
            padding: "0.3rem 1.0rem"
          }
        }, meds.doc_name, " (", meds.doc_username, ") ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
