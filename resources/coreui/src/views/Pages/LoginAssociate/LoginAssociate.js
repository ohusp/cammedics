...
class LoginAssociate extends Component {
  constructor(props) {
    super(props)
    this.state = {
        id: '',
        ...
        .then(json => {
          ...
          // ///////////////////////////////
            if (json.data.success) {
                ...
                localStorage["login_from"] = "associate";
                ...
                const timeout = setTimeout(() => {
                  ...
                  this.props.history.push(`/profile_associate`)
                )
            } else {
                    ...
                    <Form noValidate onSubmit={this.onSubmit}>
                      ...
                      <Row>
                        ...
                        <Col xs="6" className="text-right">
                          <Link to="/forgetpassword_associate">
