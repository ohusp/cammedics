...
class ResetPasswordAssociate extends Component {
  constructor(props) {
    super(props)
    this.state = {
      // first_name: '',
  ...
  onSubmit(e){
    ...
    // validate check if theres no error in the form 
      ...
      axios
        .post('api/associate/resetPassword', { user: encrypted_user_data }, {
    ...
    try {
      ...
      .then(json => {
        // if password reset is allowed stay on page, else redirect
          ...
          } else this.props.history.push(`/login_associate`);
      })
      .catch(err => {
          ...
          <Row className="justify-content-center">
            <Col md="8">
              <div className="mb-3 mx-auto text-center">
                ...
                <h5 className="text-center" style={{marginTop: "15px"}}>Associate</h5>
              </div>
              <CardGroup>
                <Card className="p-4">
                  <CardBody>
...
export default ResetPasswordAssociate;
