...
class RegisterAssociate extends Component {
  constructor(){
    super()
    this.state = {
      username: '',
  ...
  onSubmit(e){
    ...
    // validate check if theres no error in the form 
      ...
      axios
        .post('api/associate/register', { user: encrypted_user_data }, {
            ...
            <Col md="9" lg="7" xl="6">
              ...
              <Card className="mx-4">
                <CardBody className="p-4">
                  ...
                  <br></br><p>Already have an account? <a href="/#/login_associate">sign in</a></p>
                </CardBody>
