...
class AssociatePharmAdd extends Component {
  constructor(props) {
    super(props);
    ...
    this.onChangePharmacyCountry        = this.onChangePharmacyCountry.bind(this);
  ...
  onChangePharmacyCountry(e)        { this.setState({ country:e.target.value  }); }
  onChangeDistrictProvinceState(e)  { this.setState({ district_province_state:e.target.value  }); }
  onChangePharmacyAddress(e)        { this.setState({ address:e.target.value  }); }
  ...
  onSubmit(e)
  {
    ...
    if(
      ...
      const pharm_data1 = AesEncrypt(pharm_data, 'where do you go when you by yourself' );
      axios.post(`/api/associate/pharm/add/`+this.state.id+`?token=${this.state.token}`, { user: pharm_data1 })
      .then(response => {
        ...
        <Row>
            <Col xs="12" sm="12">
              ...
              <Card>
                ...
                {/* // ///////////////// ////////////// */}
                <CardHeader>
                  <i className="fa fa-align-justify"></i><strong>Pharmacy's Data</strong>
                </CardHeader>
                <CardBody>
                  <Form onSubmit={this.onSubmit}>
                      ...
                      <Col xs="12" sm="12">
                        ...
                        <FormGroup>
                          <InputGroup>
                            ...
                            <Input type="select" id="country" value={this.state.country} onChange={this.onChangePharmacyCountry}>
                              {this.state.countries.map(country => {
                                return (
                        ...
                        <FormGroup>
                          <InputGroup>
                            ...
                            <Input type="textarea" id="address" rows="2" defaultValue={this.state.address} onChange={this.onChangePharmacyAddress} placeholder=" Address" />
                            <InputGroupAddon addonType="append">
                              <InputGroupText><i className="fa fa-asterisk"></i></InputGroupText>
                            </InputGroupAddon>
                          </InputGroup>
                    ...
                    <FormGroup className="form-actions">
                      <Button type="submit" size="sm" color="primary">Add Pharmacy</Button>
                    </FormGroup>
                  </Form>
                </CardBody>
              </Card>
...
export default AssociatePharmAdd;
