...
class AssociateLabAdd extends Component {
  constructor(props) {
    super(props);
    ...
    this.onChangeLaboratoryCountry        = this.onChangeLaboratoryCountry.bind(this);
    this.onChangeDistrictProvinceState  = this.onChangeDistrictProvinceState.bind(this);
    this.onChangeLaboratoryAddress        = this.onChangeLaboratoryAddress.bind(this);
    // ///////////////////////////////////////////////////////////////////////////////
  ...
  onChangeLaboratoryCountry(e)        { this.setState({ country:e.target.value  }); }
  onChangeDistrictProvinceState(e)  { this.setState({ district_province_state:e.target.value  }); }
  onChangeLaboratoryAddress(e)        { this.setState({ address:e.target.value  }); }
  ...
  onSubmit(e)
  {
    ...
    if(
      ...
      const laboratory_data1 = AesEncrypt(laboratory_data, 'where do you go when you by yourself' );
      axios.post(`/api/associate/lab/add/`+this.state.id+`?token=${this.state.token}`, { user: laboratory_data1 })
      .then(response => {
                ...
                <CardBody>
                  <Form onSubmit={this.onSubmit}>
                      ...
                      <Col xs="12" sm="12">
                        ...
                        <FormGroup>
                          <InputGroup>
                            ...
                            <Input type="select" id="country" value={this.state.country} onChange={this.onChangeLaboratoryCountry}>
                              {this.state.countries.map(country => {
                                return (
                        ...
                        <FormGroup>
                          <InputGroup>
                            ...
                            <Input type="textarea" id="address" rows="2" defaultValue={this.state.address} onChange={this.onChangeLaboratoryAddress} placeholder=" Address" />
                            <InputGroupAddon addonType="append">
                              <InputGroupText><i className="fa fa-asterisk"></i></InputGroupText>
                            </InputGroupAddon>
                          </InputGroup>
                    ...
                    <FormGroup className="form-actions">
                      <Button type="submit" size="sm" color="primary">Add Laboratory</Button>
                    </FormGroup>
                  </Form>
                </CardBody>
              </Card>
...
export default AssociateLabAdd;
