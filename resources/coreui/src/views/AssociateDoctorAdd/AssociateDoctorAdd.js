...
class AssociateDoctorAdd extends Component {
  constructor(props) {
    super(props);
    // ////////////////MODAL
  ...
  onSubmit(e)
  {
    ...
    if(
      ...
      axios.post(`/api/associate/doctor/add/`+this.state.id+`?token=${this.state.token}`, { user: encrypted_user_data })
      .then(response => {
...
export default AssociateDoctorAdd;
