...
class AssociateHospitalAdd extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit(e)
  {
    ...
    if(
      ...
      const hospital_data1 = AesEncrypt(hospital_data, 'where do you go when you by yourself' );
      axios.post(`/api/associate/hospital/add/`+this.state.id+`?token=${this.state.token}`, { user: hospital_data1 })
      .then(response => {
        ...
        <Row>
            <Col xs="12" sm="12">
              ...
              <Card>
                ...
                {/* // ///////////////// ////////////// */}
                <CardHeader>
                  <i className="fa fa-align-justify"></i><strong>Hospital's Data</strong>
                </CardHeader>
                <CardBody>
                  <Form onSubmit={this.onSubmit}>
                    ...
                    <FormGroup className="form-actions">
                      <Button type="submit" size="sm" color="primary">Add Hospital</Button>
                    </FormGroup>
                  </Form>
                </CardBody>
              </Card>
...
export default AssociateHospitalAdd;
